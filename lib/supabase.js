...
export const signUp = async (email, password, userType = 'user', profileData = {}, locationData = {}) => {
  try {
    console.log('Starting signup process for:', email, 'with type:', userType);
...
export const signIn = async (email, password) => {
  try {
    ...
    if (profileError) {
      ...
      // Don't fail signin if profile fetch fails, just log it
      console.warn('Could not fetch profile, user may need to complete setup');
    }
...
export const getAreasByDistrict = async (districtId) => {
  try {
    // Static data for demo. In production, this would be a proper areas table
    const areasByDistrict = {
      '1-1': [ // Mumbai
        { id: '1-1-1', name: 'Andheri', code: 'AND', district_id: '1-1' },
        { id: '1-1-2', name: 'Bandra', code: 'BAN', district_id: '1-1' },
        { id: '1-1-3', name: 'Colaba', code: 'COL', district_id: '1-1' },
        { id: '1-1-4', name: 'Dadar', code: 'DAD', district_id: '1-1' },
      ],
      '1-2': [ // Pune
        { id: '1-2-1', name: 'Koregaon Park', code: 'KOR', district_id: '1-2' },
        { id: '1-2-2', name: 'Hinjewadi', code: 'HIN', district_id: '1-2' },
        { id: '1-2-3', name: 'Wakad', code: 'WAK', district_id: '1-2' },
      ],
      '2-1': [ // Bangalore
        { id: '2-1-1', name: 'Whitefield', code: 'WHI', district_id: '2-1' },
        { id: '2-1-2', name: 'Koramangala', code: 'KOR', district_id: '2-1' },
        { id: '2-1-3', name: 'Indiranagar', code: 'IND', district_id: '2-1' },
      ]
    };
    
    return { data: areasByDistrict[districtId] || [], error: null };
  } catch (error) {
...
export const getAreas = async () => {
  try {
    // Return all areas for admin purposes
    const allAreas = [
      { id: '1-1-1', name: 'Andheri', code: 'AND' },
      { id: '1-1-2', name: 'Bandra', code: 'BAN' },
      { id: '1-1-3', name: 'Colaba', code: 'COL' },
      { id: '1-2-1', name: 'Koregaon Park', code: 'KOR' },
      { id: '2-1-1', name: 'Whitefield', code: 'WHI' },
      { id: '2-1-2', name: 'Koramangala', code: 'KOR' },
    ];
    
    return { data: allAreas, error: null };
  } catch (error) {
    console.error('Get areas error:', error);
    return { data: null, error };
  }
...
export const getDepartments = async () => {
  try {
    // Static departments data for demo
    const departments = [
      { id: '1', name: 'Public Works', code: 'PW', category: 'infrastructure', description: 'Roads, bridges, and public infrastructure' },
      { id: '2', name: 'Water & Utilities', code: 'WU', category: 'utilities', description: 'Water supply, sewage, and utilities' },
      { id: '3', name: 'Parks & Recreation', code: 'PR', category: 'parks', description: 'Parks, gardens, and recreational facilities' },
      { id: '4', name: 'Environmental Services', code: 'ES', category: 'environment', description: 'Waste management and environmental protection' },
      { id: '5', name: 'Public Safety', code: 'PS', category: 'safety', description: 'Public safety and emergency services' },
    ];
