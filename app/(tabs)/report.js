            ...
            <View style={styles.form}>
                ...
                <View style={styles.inputGroup}>
                    ...
                    <View style={styles.categoryGrid}>
                        {categories.map((category) => (
                            ...
                            >
                                <Text style={styles.categoryIcon}>{String(category.icon)}</Text>
                                <Text
                                    style={[
                                        styles.categoryText,
                ...
                <View style={styles.infoSection}>
                    ...
                    <View style={styles.infoText}>
                        <Text>• Your report will be automatically routed to the area administrator</Text>
                        <Text>• The area admin will review and assign to the appropriate department</Text>
                        <Text>• Department will create tenders for contractors if needed</Text>
                        <Text>• You'll receive updates throughout the resolution process</Text>
                        <Text>• You earn points for contributing to your community</Text>
                    </View>
                </View>
            </View>
